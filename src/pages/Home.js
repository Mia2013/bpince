...
export default function Home() {
  const images = [
    ...
    {
      src: `${process.env.PUBLIC_URL}/pic/about.jpg`,

      position: "top",
    },
    {
      src: `${process.env.PUBLIC_URL}/pic/slideshow.jpg`,

      position: "center",
    },
    {
      src: `${process.env.PUBLIC_URL}/pic/slideshow2.jpg`,

      position: "bottom",
    },
    {
      src: `${process.env.PUBLIC_URL}/pic/slideshow3.jpg`,
